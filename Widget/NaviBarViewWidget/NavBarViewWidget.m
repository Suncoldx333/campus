...
- (void)drawRect:(CGRect)rect
{
    ...
    //左边图片视图
    if (self.leftIcon) {
        CGFloat leftIconX = 11.5f;
        CGFloat leftIconW =  15;
    ...
    CGFloat centerViewW = NAV_VIEW_ITEM_WIDTH * 3;
    ...
    if (self.centerTitle) {
        ...
        _centerLabel.font = centerTitleFont;
    ...
    //右侧标题视图
    if (self.rightTitle) {
        CGFloat rightLabelW = 40.f;
        CGFloat rightLabelX = CGRectGetWidth(_rightView.frame) - 14.f - rightLabelW;
    ...
    //右边图片视图
    if (self.rightIcon) {
//        CGFloat rightIconW = 20.f;
//        CGFloat rightIconX = CGRectGetWidth(_rightView.frame) - rightIconW - 10 - 5;
//        CGFloat rightIconY = 13.f;
//        CGFloat rightIconH = CGRectGetHeight(_rightView.frame) - 25;
        
        CGFloat rightIconW = 22.f;
        CGFloat rightIconX = CGRectGetWidth(_rightView.frame) - rightIconW - 13;
        CGFloat rightIconY = 11.f;
        CGFloat rightIconH = 20.f;
